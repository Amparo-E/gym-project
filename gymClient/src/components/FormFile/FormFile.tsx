...
export const FormFile = () => {
  ...
  const { data, setData, setSelectedDay } = useData();
  ...
  return (
    ...
    >
      <label className="h-full w-full flex items-center justify-center mb-4 cursor-pointer rounded-lg shadow-lg border-2 border-orange-300 hover:bg-orange-400 transition-colors">
        ...
        />
        <p className="z-10 text-lg font-medium text-center pl-3"> {selectedFile ? selectedFile.name : 'Click here to upload the file'} </p>
      </label>
